...
def create_ic03(output_path):
  ...
  lexicon_path = os.path.join(FLAGS.data_dir, 'lexicon_full')
  with open(lexicon_path, 'r') as lexicon_full_file:
    lexicon_full = [tline.rstrip('\n') for tline in lexicon_full_file.readlines()]
  count = 0
  for image in images:
...
if __name__ == '__main__':
  create_ic03('data/ic03_test_fulllex.tfrecord')
